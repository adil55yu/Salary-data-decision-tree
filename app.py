...
# -------------------------------
with open("/kaggle/working/decision_tree_salary_model.pkl", "rb") as file:
    model = pickle.load(file)

# Load dataset (optional: show in app)
...
if st.button("Predict Salary"):
    # Predict directly (Decision Tree does not require scaling)
